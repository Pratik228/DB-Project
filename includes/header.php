                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="medications.php">Medications</a>
                            <a class="dropdown-item" href="pharmacists.php">Pharmacists</a>
...
<!-- The rest of your page content follows here in other files that include this header. -->
